...
class BreedRouter: NSObject, BreedRoutingLogic, BreedDataPassing
{
  ...
  //func navigateToSomewhere(source: BreedViewController, destination: SomewhereViewController)
  //{
  ...
  //func passDataToSomewhere(source: BreedDataStore, destination: inout SomewhereDataStore)
  //{
